  ...
  return (
    ...
    <section className="max-w-6xl mx-auto flex justify-center items-center flex-col">
      ...
      <div className="w-full md:w-[50%] mt-6 px-3">
        ...
        bg-white border border-gray-300 rounded transition ease-in-out'></input>
        ...
        <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
          <p className=" flex items-center ">
            ...
            <span   onClick={() => {
                  ...
                  }} className='text-red-600 hover:text-red-700 transiton ease-in-out duration-200 ml-1
            cursor-pointer'> {changeDetail ? "Appy Change " : "Edit "} </span>
          </p>
        ...
        <button type='submit' className='w-full bg-blue-600 text-white uppercase px-7 py-3 text-sm font-medium rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg
         active:bg-blue-800' > 
